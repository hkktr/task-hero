...
const MOCK_UPCOMING = [
  ...
  { id: 2, date: 'OCT 28', title: 'Weekend Food Distribution Center', desc: 'Helping sort and pack donation boxes for families.' },
]
        ...
        <div className="flex flex-col items-center gap-3 w-52 shrink-0">
          ...
          {editing ? (
            ...
            <>
              ...
              <button
                onClick={() => { setDraftName(name); setDraftRole(role); setEditing(true) }}
                  ...
                  <div key={item.id} className="flex gap-4 py-4 items-start">
                    ...
                    <div className="flex flex-col gap-0.5 flex-1">
                      ...
                      <div className="flex gap-2 mt-2">
                        ...
                        >
                          <svg className="w-4 h-4 text-[#ff6666]" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
