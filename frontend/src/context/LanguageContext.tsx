...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'welcome.sub': { en: "Kindred Hearth is more than a platform—it's a digital community center built on empathy, connecting neighbors for meaningful support and local impact.", pl: 'TaskHero to więcej niż platforma — to cyfrowe centrum społeczności oparte na empatii, łączące sąsiadów dla wzajemnego wsparcia i lokalnych zmian.' },
  'welcome.card.title': { en: 'New Request', pl: 'Nowe ogłoszenie' },
  'welcome.card.time': { en: '2 mins ago', pl: '2 min temu' },
  'welcome.card.text': { en: '"Looking for a hand with gardening this Saturday morning..."', pl: '"Szukam pomocy przy ogrodzie w tę sobotę rano..."' },
  'welcome.howTitle': { en: 'Simple Acts, Big Impact', pl: 'Proste Działania, Wielka Zmiana' },
  'welcome.howSub': { en: 'Our process is designed to be frictionless, safe, and deeply personal.', pl: 'Nasz proces jest prosty, bezpieczny i głęboko osobisty.' },
  'welcome.step1.title': { en: 'Find Your Kindred', pl: 'Znajdź Swojego Sąsiada' },
  'welcome.step1.desc': { en: 'Browse local requests or offer your specific skills. We match hearts based on proximity and passion.', pl: 'Przeglądaj lokalne ogłoszenia lub zaoferuj swoje umiejętności. Łączymy ludzi na podstawie bliskości i pasji.' },
  'welcome.step2.title': { en: 'Connect Directly', pl: 'Połącz się Bezpośrednio' },
  'welcome.step2.desc': { en: 'Chat within our secure portal to finalize details. No awkward intermediaries, just neighbors talking to neighbors.', pl: 'Rozmawiaj przez bezpieczny portal. Żadnych pośredników — tylko sąsiedzi rozmawiający z sąsiadami.' },
  'welcome.step3.title': { en: 'Spark Joy', pl: 'Rozpal Radość' },
  'welcome.step3.desc': { en: 'Complete the task and share the story. Every fulfilled request strengthens the fabric of our hearth.', pl: 'Wykonaj zadanie i podziel się historią. Każda spełniona prośba wzmacnia naszą społeczność.' },
  'welcome.statsTitle': { en: 'Our Growing Hearth', pl: 'Nasza Rosnąca Społeczność' },
  'welcome.statsSub': { en: 'Real numbers from real people making a difference every single day.', pl: 'Prawdziwe liczby od prawdziwych ludzi, którzy codziennie robią różnicę.' },
  ...
  'welcome.reachSub': { en: 'Spreading warmth across 45 unique communities and counting.', pl: 'Ciepło rozchodzi się po 45 unikalnych społecznościach i wciąż rośnie.' },
  ...
  'explore.sub': { en: 'Discover opportunities to connect with your community and make a meaningful difference today.', pl: 'Odkryj możliwości połączenia się ze społecznością i wprowadź znaczącą zmianę już dziś.' },
  ...
  'post.step1.titleHint': { en: 'Think of this as a headline. Be specific so neighbors know exactly how they can lend a hand.', pl: 'Potraktuj to jak nagłówek. Bądź konkretny, żeby sąsiedzi wiedzieli dokładnie jak pomóc.' },
  'post.step1.titlePlaceholder': { en: 'e.g., Need help moving a sofa this Saturday', pl: 'np. Potrzebuję pomocy przy przeprowadzce w sobotę' },
  'post.step1.catLabel': { en: 'What kind of help do you need?', pl: 'Jakiego rodzaju pomocy potrzebujesz?' },
  'post.step1.catHint': { en: 'Selecting the right category helps us match you with the best available community members.', pl: 'Wybór właściwej kategorii pomoże nam dopasować najlepszych wolontariuszy.' },
  'post.step1.descLabel': { en: 'Describe the details', pl: 'Opisz szczegóły' },
  'post.step1.descHint': { en: 'Share a little more about the situation. The more detail you provide, the faster people can say "yes!"', pl: 'Opisz sytuację dokładniej. Im więcej szczegółów, tym szybciej ktoś powie "tak!"' },
  'post.step1.descPlaceholder': { en: "e.g., I'm moving from a 2nd-floor apartment...", pl: 'np. Przeprowadzam się z mieszkania na 2. piętrze...' },
  ...
  'post.step1.tip': { en: 'Requests with a friendly description and a clear photo (you\'ll add this later)', pl: 'Ogłoszenia z przyjaznym opisem i wyraźnym zdjęciem (dodasz je później) uzyskują więcej odpowiedzi.' },
  ...
  'post.step2.volunteersHint': { en: 'How many people are needed for this task?', pl: 'Ile osób jest potrzebnych do tego zadania?' },
  'post.step2.btn': { en: 'Add Media', pl: 'Dodaj zdjęcia' },
  'post.step2.tip1': { en: 'Allow for a 30-minute buffer for greeting and setup.', pl: 'Zostaw 30 minut na powitanie i przygotowanie.' },
  'post.step2.tip2': { en: 'For heavy tasks, 2-3 volunteers is usually ideal.', pl: 'Przy ciężkich zadaniach 2-3 wolontariuszy to zwykle ideał.' },
  ...
  'cat.moving': { en: 'Moving & Lifting', pl: 'Przeprowadzka' },
  'cat.gardening': { en: 'Gardening', pl: 'Ogrodnictwo' },
  'cat.petCare': { en: 'Pet Care', pl: 'Opieka nad zwierzętami' },
  'cat.grocery': { en: 'Grocery Pickup', pl: 'Zakupy' },
  'cat.handyman': { en: 'Handyman', pl: 'Majsterkowanie' },
  // Review
  ...
  'review.notePlaceholder': { en: 'Click here to add a note for users', pl: 'Naciśnij tutaj, aby dodać notatkę dla użytkowników' },
  'review.accept': { en: 'Accept', pl: 'Zaakceptuj' },
  'review.rejectPlaceholder': { en: 'Click here to write a rejection reason', pl: 'Naciśnij tutaj, aby napisać uzasadnienie' },
