...
const translations = {
  ...
  // Admin
  'admin.count': { en: 'Requests', pl: 'Zgłoszenia' },
  'admin.review': { en: 'Review', pl: 'Przejrzyj' },
  'admin.heading': { en: 'Moderation', pl: 'Panel' },
  'admin.headingAccent': { en: 'panel', pl: 'moderacji' },
  'admin.sub': {
  ...
  'admin.empty.title': { en: 'No requests found', pl: 'Brak zgłoszeń' },
  'admin.empty.sub': {
    en: 'No request under this status.',
    pl: 'Nie znaleziono żadnych ogłoszeń dla wybranego statusu.',
  },
  'admin.approvalStatus.0': { en: 'Pending', pl: 'Oczekujące' },
  'admin.approvalStatus.1': { en: 'Rejected', pl: 'Odrzucone' },
  'admin.approvalStatus.2': { en: 'Approved', pl: 'Zatwierdzone' },
  // Form errors
